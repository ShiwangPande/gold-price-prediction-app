...
image = Image.open('gold.wepb')
st.image(image, wifth=200, caption='Gold', use_column_width=True)
...
st.write("The data used in this project is from Kaggle")
st.write("The data is from 2010-2019")
